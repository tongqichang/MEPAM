...
# 读取Excel文件
file_path = r"C:\Users\LEGION\Desktop\第六部分网络图\纤维素酶catalysis.xlsx"
df = pd.read_excel(file_path, sheet_name='cellulase_catalysis_id')
...
# 保存到新的Excel文件
output_path = r"C:\Users\LEGION\Desktop\第六部分网络图\catalysis_edge.xlsx"
